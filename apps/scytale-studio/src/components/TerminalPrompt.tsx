...
export function TerminalPrompt({ logs, onClearLogs, isExecuting = false }: TerminalPromptProps) {
    ...
    return (
        <section className="h-56 flex-shrink-0 border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div ref={containerRef} className="h-[calc(100%-2rem)] w-full bg-white px-2 py-1 dark:bg-zinc-950" />
        </section>
    );
}
